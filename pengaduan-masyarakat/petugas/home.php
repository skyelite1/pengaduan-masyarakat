...
$nama = $koneksi->query("select nama_petugas from petugas where id_petugas = '$id' ");
?>
...
<?php while ($data = mysqli_fetch_array($nama)) { ?>
        <h1 class="cover-heading">SELAMAT DATANG PETUGAS</h1>
    <?php } ?>
        <p class="lead">Halo Petugas silahkan cek data laporan dengan menekan button di bawah ini</p>
        <p class="lead">
          <a href="dashboard.php" class="btn btn-lg btn-secondary">liat laporan</a>
        </p>
      </main>
      </div>
